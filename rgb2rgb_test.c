...
static unsigned char * alloc_and_read_png_color(size_t *out_width, size_t *out_height, const char *file_name)
{
    int i;
    size_t width;
    size_t height;
...
int main(int argc, char *argv[])
{
    ...
    if (argc != 3) {
        printf("Usage:\n");
        printf("%s <input png (rgb) file> <outout png file name>", argv[0]);
        return -1;
    }
